...
database_properties = [
  ...
  "-Dtest.db.mysql_5_5.url=jdbc:mysql://127.0.0.1:30055/hexane?useSSL=false",
  "-Dtest.db.mysql_5_6.url=jdbc:mysql://127.0.0.1:30056/hexane?useSSL=false",
  "-Dtest.db.mysql_5_7.url=jdbc:mysql://127.0.0.1:30057/hexane?useSSL=false",
  "-Dtest.db.mysql_8_0.url=jdbc:mysql://127.0.0.1:30080/hexane?useSSL=false",
