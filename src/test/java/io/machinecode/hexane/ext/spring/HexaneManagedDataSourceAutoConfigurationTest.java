...
import io.machinecode.hexane.HexaneManagedDataSource;
...
@SpringBootTest(
    classes = {
      HexaneManagedDataSourceAutoConfiguration.class,
    },
    properties = {
      "spring.datasource.type=io.machinecode.hexane.HexaneManagedDataSource",
      ...
      "spring.datasource.hexane.url=jdbc:hsqldb:mem:HexaneManagedDataSourceAutoConfigurationTest",
    })
public class HexaneManagedDataSourceAutoConfigurationTest extends SpringTestBase {

  @Inject HexaneManagedDataSource db;
