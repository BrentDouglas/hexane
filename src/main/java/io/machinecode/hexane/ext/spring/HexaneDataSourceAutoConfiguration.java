...
@ConditionalOnProperty(
    ...
    havingValue = "io.machinecode.hexane.HexaneDataSource",
    matchIfMissing = true)
class HexaneDataSourceAutoConfiguration {
  ...
  public DataSource dataSource(final HexaneProperties properties)
    ...
    if (properties.getJndiName() != null) {
      ...
      return builder.buildDataSource(SpringUtil.bind((DataSource) ret, properties));
    } else {
      return builder.buildDataSource(SpringUtil.getDriverDataSource(properties));
    }
  }
}
