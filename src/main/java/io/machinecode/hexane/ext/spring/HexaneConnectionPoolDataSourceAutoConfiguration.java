...
@ConditionalOnProperty(
    ...
    havingValue = "io.machinecode.hexane.HexaneConnectionPoolDataSource",
    matchIfMissing = true)
class HexaneConnectionPoolDataSourceAutoConfiguration {
  ...
  public DataSource dataSource(final HexaneProperties properties)
    ...
    if (properties.getJndiName() != null) {
      ...
      return builder.buildConnectionPoolDataSource(
          SpringUtil.bind((ConnectionPoolDataSource) ret, properties));
    } else if (properties.getDataSourceClassName() != null) {
      final Object ret =
          SpringUtil.newInstance(properties.getClassLoader(), properties.getDataSourceClassName());
      return builder.buildConnectionPoolDataSource(
          SpringUtil.bind((ConnectionPoolDataSource) ret, properties));
    }
